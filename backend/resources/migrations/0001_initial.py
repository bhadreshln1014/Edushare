    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resource_type', models.CharField(choices=[('lesson_plan', 'Lesson Plan'), ('worksheet', 'Worksheet'), ('video', 'Video'), ('presentation', 'Presentation'), ('assessment', 'Assessment'), ('other', 'Other')], max_length=20)),
